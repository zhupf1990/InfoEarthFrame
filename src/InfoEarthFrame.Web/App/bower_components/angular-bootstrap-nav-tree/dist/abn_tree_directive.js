              ...
              template: function (element, attrs) {
                  ...
                  if (angular.isDefined(attrs.micTableTree)) {
                      ...
                      tmp = '<ul class="nav nav-list nav-pills nav-stacked abn-tree">' +
                           ...
                           '             <label class="tree-label" ng-class="{\'blue-label\':row.branch.checked}" for="treeidck_{{row.branch.uid}}" >{{ row.tree_icon }}</label>' +
                           '         </div>' +
                  ...
                  on_treeData_change = function () {
                      ...
                      add_branch_to_list = function (level, branch, visible) {
                          ...
                          scope.tree_rows.push({
                              ...
                              tree_icon: branch.img,
                              tree_icon2: tree_icon,
                              visible: visible
                          });
                          if (branch.children != null) {
                              _ref = branch.children;
